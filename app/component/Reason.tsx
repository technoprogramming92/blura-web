  ...
  return (
    <section className="w-full bg-white py-16 px-4 sm:px-8">
      <div className="main-container max-w-[1270px] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-[109px] items-center">
        {/* Left Image */}
        <div className="w-full max-w-[321px] h-[320px] sm:h-[400px] lg:h-[482px] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-08-21/bOwGUgKDbZ.png)] bg-cover bg-no-repeat rounded-md flex-shrink-0" />

        {/* Right Content */}
        <div className="flex flex-col gap-5 lg:gap-[20px] w-full max-w-[758px]">
